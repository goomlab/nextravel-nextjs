...
module.exports = __webpack_require__("X1Qu");
...
/* harmony import */ var _packages_TravelgoOne_services_PageFilterService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("t3yc");
...
const createSitemap = models => `<?xml version="1.0" encoding="UTF-8"?>
  ...
  return `
                    <url>
                        <loc>${`${"https://www.nextravel.it"}/offerte/${model.slug.it}`}</loc>
...
class Sitemap extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  static async getInitialProps({
    ...
    let service = new _packages_TravelgoOne_services_PageFilterService__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"]();
